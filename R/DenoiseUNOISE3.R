...
DenoiseUNOISE3 <- function(UsePrimerFile=FALSE,usearchdest="usearch"){
  ...
  for (primer in primers){
    ...
    for (loopfile in loopfiles){
      ...
      maparg <- paste("-usearch_global 3.strippedreads/",loopfile,".stripped.fastq -db 5.OTUs/",primer,".unoise3.OTUs.fasta -id 0.97 -blast6out 6.mappings/hits.unoise3.",primer,".",loopfile,".txt -strand plus -maxhits 1",sep="")
